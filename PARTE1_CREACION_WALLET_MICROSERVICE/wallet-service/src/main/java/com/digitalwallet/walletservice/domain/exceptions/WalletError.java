...
public class WalletError {
    ...
    public WalletError(HttpStatus status, String message, List<String> errors) {
        super();
        this.status = status;
        this.message = message;
        this.errors = errors;
    }
    public WalletError(HttpStatus status, String message, List<String> errors,String code) {
        super();
        this.status = status;
        this.message = message;
        this.errors = errors;
